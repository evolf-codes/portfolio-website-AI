...
description: Build or refine the portfolio performance sample when demonstrating workload modelling, service objectives, k6 thresholds, and decision-ready analysis.
---
...
Define the workload, ramp, steady-state window, latency percentiles, throughput, and error thresholds before scripting. Prefer a small k6 scenario and checked-in configuration. Capture system and test conditions so results can be compared honestly.
